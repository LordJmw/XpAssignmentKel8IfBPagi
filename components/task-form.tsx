...
export function TaskForm({ onSubmit, initialTask, isEditing, onCancel, fullHeight = false }: TaskFormProps) {
  ...
  // If fullHeight is true, render just the form content without the card
  if (fullHeight) {
    return (
  ...
  // Default card-based form for non-fullHeight mode
  return (
